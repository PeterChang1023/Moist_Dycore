...
function Compute_Geopotential!(vert_coord::Vert_Coordinate, atmo_data::Atmo_Data, 
  ...
  grid_geopots::Array{Float64, 3}, grid_geopot_full::Array{Float64, 3}, grid_geopot_half::Array{Float64, 3}, grid_tracers_c::Array{Float64, 3})
  ...
  virtual_t = deepcopy(grid_tracers_c).*0.
